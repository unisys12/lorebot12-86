...
function searchGrimoire(input) {
  ...
  return (
    "http://www.ishtar-collective.net/search/" + encodeURIComponent(stripeCmd)
  );
}
...
function quotes(input, cb) {
  ...
  switch (npc) {
    ...
    default:
      return cb(
        null,
        "Sorry, either that NPC does not exist or I have not gathered their quotes just yet. For a listing of supported NPC's issue the following command `!quotes help`."
      );
  }
}
...
module.exports.quotesHelp = quotesHelp;
